...
const ConfirmDepositModal = ({ show, onClose, onConfirm, isSubmitting, amount }) => {
    return (
        <ModalShell show={show} onClose={onClose} title="⚠️ Confirm Deposit">
            ...
            <div className="d-flex gap-2">
                ...
                >
                    {isSubmitting ? "DEPOSITING..." : "✅ Yes, Deposit Now"}
                </button>
            </div>
